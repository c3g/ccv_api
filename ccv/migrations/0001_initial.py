# Generated by Django 3.0.5 on 2020-05-16 17:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('organisation', models.CharField(blank=True, help_text='Main funding org name who has funced this contribution', max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('title', models.CharField(blank=True, help_text='The title of the article', max_length=250, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doi', models.CharField(blank=True, help_text='digital object identifier (DOI) for this publication', max_length=50, null=True)),
                ('description_of_role', models.CharField(blank=True, help_text='brief description of your contribution role towards this publication', max_length=1000, null=True)),
                ('funding_source', models.ManyToManyField(related_name='ccv_translation_related', related_query_name='ccv_translations', to='ccv.FundingSource')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, help_text='Provide a concise description of this contribution and its value to the area of research for which you are applying for funding', max_length=1000, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('funding_source', models.ManyToManyField(related_name='ccv_onlineresource_related', related_query_name='ccv_onlineresources', to='ccv.FundingSource')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('Accepted', 'Accepted'), ('In Press', 'In Press'), ('Published', 'Published'), ('Revision Requested', 'Revision Requested'), ('Submitted', 'Submitted')], help_text='The status of the paper with regard to publication', max_length=30, null=True)),
                ...
                ('funding_source', models.ManyToManyField(related_name='ccv_manual_related', related_query_name='ccv_manuals', to='ccv.FundingSource')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authors', models.CharField(blank=True, help_text='The names of other authors', max_length=1000, null=True)),
                ('editors', models.CharField(blank=True, help_text='The names of the editors', max_length=200, null=True)),
                ('funding_source', models.ManyToManyField(related_name='ccv_magazineentry_related', related_query_name='ccv_magazineentrys', to='ccv.FundingSource')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doi', models.CharField(blank=True, help_text='digital object identifier (DOI) for this publication', max_length=50, null=True)),
                ('description_of_role', models.CharField(blank=True, help_text='brief description of your contribution role towards this publication', max_length=1000, null=True)),
                ('journal', models.CharField(blank=True, help_text='The title of the journal', max_length=200, null=True)),
                ('funding_source', models.ManyToManyField(related_name='ccv_journalissue_related', related_query_name='ccv_journalissues', to='ccv.FundingSource')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('Accepted', 'Accepted'), ('In Press', 'In Press'), ('Published', 'Published'), ('Revision Requested', 'Revision Requested'), ('Submitted', 'Submitted')], help_text='The status of the paper with regard to publication', max_length=30, null=True)),
                ('year', models.CharField(blank=True, help_text='year relative to the Publishing Status', max_length=4, null=True)),
                ('publisher', models.CharField(blank=True, help_text='The name of the publisher of the conference proceedings', max_length=100, null=True)),
                ('publication_location', models.CharField(blank=True, help_text='The country of publication', max_length=50, null=True)),
                ...
                ('funding_source', models.ManyToManyField(related_name='ccv_conferencepublication_related', related_query_name='ccv_conferencepublications', to='ccv.FundingSource')),
                ('publication', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ccv.Publication')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doi', models.CharField(blank=True, help_text='digital object identifier (DOI) for this publication', max_length=50, null=True)),
                ('description_of_role', models.CharField(blank=True, help_text='brief description of your contribution role towards this publication', max_length=1000, null=True)),
                ('funding_source', models.ManyToManyField(related_name='ccv_bookchapter_related', related_query_name='ccv_bookchapters', to='ccv.FundingSource')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doi', models.CharField(blank=True, help_text='digital object identifier (DOI) for this publication', max_length=50, null=True)),
                ('description_of_role', models.CharField(blank=True, help_text='brief description of your contribution role towards this publication', max_length=1000, null=True)),
                ('funding_source', models.ManyToManyField(related_name='ccv_book_related', related_query_name='ccv_books', to='ccv.FundingSource')),
            ],
            options={
                'abstract': False,
            },
