# Generated by Django 3.0.5 on 2020-06-12 15:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('_id', models.UUIDField(db_index=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ccv.Degree')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, help_text='The name or title of the recognition', max_length=250, null=True)),
                ('year_started', models.CharField(blank=True, help_text='The year when the recognition was awarded or took effect', max_length=4, null=True)),
                ('year_completed', models.CharField(blank=True, help_text='The year when this recognition expires', max_length=4, null=True)),
                ('amount', models.IntegerField(blank=True, help_text='The amount that was awarded for this recognition', null=True)),
                ('currency', models.CharField(blank=True, help_text='The currency in which the money was awarded', max_length=10, null=True)),
                ('organisation', models.CharField(blank=True, help_text='The organization that gave the recognition', max_length=50, null=True)),
                ('other_organization', models.CharField(blank=True, help_text='If someone cannot find the org from the list', max_length=50, null=True)),
                ('student_supervision', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ccv.StudentSupervision')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            name='StudentCountryOfCitizenShip',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('country_name', models.CharField(blank=True, help_text='Country of citizenship of the student', max_length=50, null=True)),
                ('student_supervision', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ccv.StudentSupervision')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.OneToOneField(blank=True, help_text='The organization for which the assessment was made', null=True, on_delete=django.db.models.deletion.CASCADE, to='ccv.Organization')),
                ('other_organization', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ccv.OtherOrganization')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('performance_art', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ccv.PerformanceArt')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('membership', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ccv.Membership')),
                ('organization', models.OneToOneField(blank=True, help_text='The name of the organisation of which the person is a member', null=True, on_delete=django.db.models.deletion.CASCADE, to='ccv.Organization')),
                ('other_organization', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ccv.OtherOrganization')),
            ],
            options={
                'abstract': False,
        ...
        migrations.AddField(
            ...
            name='organization',
            field=models.OneToOneField(blank=True, help_text='The name of the organization where the person worked', null=True, on_delete=django.db.models.deletion.CASCADE, to='ccv.Organization'),
        ),
        migrations.AddField(
            model_name='nonacademicworkexperience',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choreography', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ccv.Choreography')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assessment_review_activity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ccv.AssessmentAndReviewActivity')),
                ('organization', models.OneToOneField(blank=True, help_text='The institution for which the examination was conducted.', null=True, on_delete=django.db.models.deletion.CASCADE, to='ccv.Organization')),
                ('other_organization', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ccv.OtherOrganization')),
            ],
            options={
                'abstract': False,
        ...
        migrations.AddField(
            model_name='degree',
            name='education',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ccv.Education'),
        ),
        migrations.AddField(
            model_name='degree',
            name='organization',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.OneToOneField(blank=True, help_text='The organization where the course was taught ', null=True, on_delete=django.db.models.deletion.CASCADE, to='ccv.Organization')),
                ('other_organization', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ccv.OtherOrganization')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.OneToOneField(blank=True, help_text='The name of the organization for which the service was undertaken', null=True, on_delete=django.db.models.deletion.CASCADE, to='ccv.Organization')),
                ('other_organization', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ccv.OtherOrganization')),
                ('participation_activity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ccv.ParticipationActivity')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_taught', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ccv.CourseTaught')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_development', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ccv.CourseDevelopment')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='contribution',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='ccv.Contribution'),
        ),
        migrations.CreateModel(
            name='AreaOfResearch',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ccv.Employment')),
                ('organization', models.OneToOneField(blank=True, help_text='The organization with which the person is affiliated.', null=True, on_delete=django.db.models.deletion.CASCADE, to='ccv.Organization')),
                ('other_organization', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ccv.OtherOrganization')),
            ],
            options={
                'abstract': False,
